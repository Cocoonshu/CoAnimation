...
public class Smoother3 {
    ...
    public boolean smooth() {
        ...
        mCurrentValueX = mCurrentValueX + (mDestinationValueX - mCurrentValueX) * mFactor;
        mCurrentValueY = mCurrentValueY + (mDestinationValueY - mCurrentValueY) * mFactor;
        mCurrentValueZ = mCurrentValueZ + (mDestinationValueZ - mCurrentValueZ) * mFactor;
